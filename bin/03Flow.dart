...
void main() {
  ...
  if (age >= 18) {
    ...
    print(
      "if you are living in USA and CANADA, you can vote, please verify your country of residence to proceed",
    );
  } else {
    print(
      "you are not adult enough to vote, please drink water and have some sleep",
    );
  }
